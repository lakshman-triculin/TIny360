...
export class PickList implements OnDestroy,AfterViewChecked,AfterContentInit {
    ...
    onItemClick(event:any, item: any, selectedItems: any[]) {
    ...
    moveUp(listElement:any, list:any, selectedItems:any) {
    ...
    moveTop(listElement:any, list:any, selectedItems:any) {
        if(selectedItems && selectedItems.length) {
            for(let i = 0; i < selectedItems.length; i++) {
                let selectedItem = selectedItems[i];
                let selectedItemIndex: number = this.findIndexInList(selectedItem, list);
    ...
    moveDown(listElement:any, list:any, selectedItems:any) {
        if(selectedItems && selectedItems.length) {
    ...
    moveBottom(listElement:any, list:any, selectedItems:any) {
        if(selectedItems && selectedItems.length) {
            for(let i = selectedItems.length - 1; i >= 0; i--) {
                let selectedItem = selectedItems[i];
                let selectedItemIndex: number = this.findIndexInList(selectedItem, list);
    ...
    moveRight(targetListElement:any) {
    ...
    moveLeft(sourceListElement:any) {
